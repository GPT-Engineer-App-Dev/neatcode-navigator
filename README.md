...
Create the NeetCode landing page with the following requirements:

### Purpose
The NeetCode landing page is designed to help users prepare effectively for coding interviews through a structured and interactive interface.
...
```sh
git clone https://github.com/GPT-Engineer-App-Dev/neatcode-navigator.git
cd neatcode-navigator
npm i
```
